...
export default {
    ...
    STRIPE_PRICE_ASSOCIATE_MONTHLY:
        process.env.STRIPE_PRICE_ASSOCIATE_MONTHLY,

    STRIPE_PRICE_PARTNER_MONTHLY:
        process.env.STRIPE_PRICE_PARTNER_MONTHLY,

    STRIPE_PRICE_AMBASSADOR_MONTHLY:
        process.env.STRIPE_PRICE_AMBASSADOR_MONTHLY,
    ...
    STRIPE_PRICE_CEO_PARTNER_MONTHLY:
        process.env.STRIPE_PRICE_CEO_PARTNER_MONTHLY,
}